...
export default function About() {
  return (
    <div className="flex flex-col lg:flex-row items-center bg-white w-4/5 mx-[auto] bg-white px-10 md:px-20 lg:px-30 text py-14" >
      <div className="w-1/2">
        ...
        <p className="text-md font-light py-5 leading-8 text-gray-800 "> If you are searching for a dedicated front-end web developer who can transform your ideas into engaging digital experiences, I am ready to bring your vision to life. Let&apos;s collaborate and create an impactful online presence for your brand.</p>
      </div>

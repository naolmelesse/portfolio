...
export default function Nav(){
    return(
        ...
        <Image
          ...
          height={38}
        />
        <div className='invisible lg:visible flex items-center p-2  bg-[#F5F5F5] z-10 fixed translate-x-[90%] rounded-full' >
        ...
        <Link target="_blank" className='flex gap-1 items-center text-[#fff] bg-[#222831] transition duration-300 ease-in-out hover:bg-[#454545] px-4 py-2 rounded-lg' href="/Naol_Melesse-Resume(Modern).pdf" download="Naol_Melesse-Resume(Modern).pdf">Resume
